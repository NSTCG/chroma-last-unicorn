...
function createTaperedBladeGeometry(THREE, width = 0.72, height = 1.95) {
  ...
  geom.setAttribute('position', new THREE.BufferAttribute(new Float32Array([-hw,-0.15,0, hw,-0.15,0, -hw*0.92,height*0.55,0, hw*0.92,height*0.55,0, -hw*0.42,height,0, hw*0.42,height,0]), 3));
